...
when_create_new_typed_handle_should_be_ok :: proc(t: ^testing.T){
    handle_allocator := handle_containers.create_typed_handle_allocator(TestStruct);
    
    handle := handle_containers.alloc_typed_handle(&handle_allocator);
...
when_create_two_new_typed_handles_should_be_ok :: proc(t: ^testing.T){
    ...
    handle1 := handle_containers.alloc_typed_handle(&handle_allocator);
    handle2 := handle_containers.alloc_typed_handle(&handle_allocator);
...
new_typed_handle_should_be_alive :: proc(t: ^testing.T){
    ...
    testing.expect(t, handle_containers.is_typed_handle_alive(&handle_allocator, handle), "handle should be alive");
}
...
when_free_typed_handle_should_not_be_alive :: proc(t: ^testing.T){
    ...
    handle := handle_containers.alloc_typed_handle(&handle_allocator);
    handle_containers.free_typed_handle(&handle_allocator, handle);

    testing.expect(t, handle_containers.is_typed_handle_alive(&handle_allocator, handle) == false, "handle should not be alive");
}
...
when_free_typed_handle_and_alloc_new_typed_handle_should_reuse_old_handle :: proc(t : ^testing.T){
    ...
    handle1 := handle_containers.alloc_typed_handle(&handle_allocator);
    handle_containers.free_typed_handle(&handle_allocator, handle1);
    handle2 := handle_containers.alloc_typed_handle(&handle_allocator);
